...
public class MultiSelectionSpinner extends Spinner implements DialogInterface.OnMultiChoiceClickListener {
    ...
    public void onClick(DialogInterface dialog, int which, boolean isChecked) {
        ...
        if (mSelection != null && which < mSelection.length) {
            ...
            throw new IllegalArgumentException("argument which is out");
        }
    ...
    public void setAdapter(SpinnerAdapter adapter) {
        throw new RuntimeException("setadapter is not supported by multispinner");
    }
    ...
    public void setSelection(int index) {
        ...
        if (index >= 0 && index < mSelection.length) {
            ...
            throw new IllegalArgumentException("Index " + index + " is out of bonds");
        }
